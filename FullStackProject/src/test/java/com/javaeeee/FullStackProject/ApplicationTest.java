...
public class ApplicationTest {
	...
	private Item item = new Item("12", "Test Item", "Washington DC","20",100,1);
    ...
    public void createAndRetrieveItem() {
		...
		final Item testItem = client.target(String.format("http://localhost:" + RULE.getLocalPort() + "/service/items/12"))
				.request()
				.get(Item.class);
